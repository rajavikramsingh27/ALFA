              ...
              Container(
                ...
                onPressed: () {
                      ...
                      if (textEmail.text.isEmpty) {
                        ...
                        Toast.show("Enter Confirm password", context,
                            duration: 2,
                            gravity: Toast.BOTTOM,
                            backgroundColor: HexColor(redColor));
                      } else if (textConfirmPassword.text.length < 6) {
                        Toast.show(
                            "Confirm password length must be more than 6 characters",
                            context,
                            duration: 2,
                            gravity: Toast.BOTTOM,
                            backgroundColor: HexColor(redColor));
...
//                              if (value.user.uid)
                          Firestore.instance
                              ...
                              .document(value.user.email+kFireBaseConnect+ value.user.uid)
                              .setData({
                            kUserID:value.user.uid,
                            kEmail:value.user.email,
                            kPassword:textPassword.text,
