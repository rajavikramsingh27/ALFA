...
//  var strTime = '';
  ...
  getFoodDetails() {
    ...
    FirebaseAuth.instance.currentUser().then((value) {
      print(Firestore.instance.collection(tblFoodDetails).document(value.email + kFireBaseConnect + value.uid)
          .collection(formattedDate).document(foodType));
...
//        print(value.data);
        ...
        if (value.data != null && value.data.isNotEmpty) {
          ...
          strHowDidYoufeelAfter = (value.data[kHow_Did_You_Feel_After] == null) ? '' : value.data[kHow_Did_You_Feel_After];
          strHowWasYourEnergyAfter = (value.data[kHow_Was_Your_Energy_After] == null) ? '' : value.data[kHow_Was_Your_Energy_After] ;
          textOtherNotes.text = (value.data[kAny_Other_Notes_About_How_You_Felf_During_Or_After_Eating] == null) ? '' : value.data[kAny_Other_Notes_About_How_You_Felf_During_Or_After_Eating];
          strForWhatReasonDidYouHaveThisSnack = (value.data[kForWhatReasonDidYouHaveThisSnack] == null) ? '' : value.data[kForWhatReasonDidYouHaveThisSnack];
          strWhatThisSnackNutritous = (value.data[kWhatThisSnackNutritous] == null) ? '' : value.data[kWhatThisSnackNutritous];
          textOtherReason.text = (value.data[kOtherReason] == null) ? '' : value.data[kOtherReason];
          textBetterOption.text = (value.data[kWhatBetterOptionCouldYouHaveChosen] == null) ? '' : value.data[kWhatBetterOptionCouldYouHaveChosen];

          if (strHowDidYoufeelAfter == '100% Full' && strHowDidYoufeelAfter != null) {
            selectedBreakfastFeel = 1;
          } else if (strHowDidYoufeelAfter == '80% Full' && strHowDidYoufeelAfter != null) {
            selectedBreakfastFeel = 2;
          } else if (strHowDidYoufeelAfter == 'Very Hungry' && strHowDidYoufeelAfter != null) {
            selectedBreakfastFeel = 3;
          } else if (strHowDidYoufeelAfter == 'Slightly Hungry' && strHowDidYoufeelAfter != null) {
            selectedBreakfastFeel = 4;
          }

          if (value.data[kForWhatReasonDidYouHaveThisSnack] == 'Hunger') {
            selectedBreakfastFeel = 1;
          } else if (value.data[kForWhatReasonDidYouHaveThisSnack] == 'Boredom') {
            selectedBreakfastFeel = 2;
          } else if (value.data[kForWhatReasonDidYouHaveThisSnack] == 'Temptation') {
            selectedBreakfastFeel = 3;
...
//    print(dictFood);
  ...
  Future<void> selectTime(BuildContext context) async {
    ...
    setState(() {
      ...
      final dt = DateTime(now.year, now.month, now.day, timePicked.hour, timePicked.minute);
                                    ...
                                    return GestureDetector(
                                      ...
                                      onTap: () {
                                        ...
                                        if (index == 0) {
                                          ...
                                          howDidYoufeelAfter = 'How did you feel after lunch?';
                                          howWasYourEnergyAfter = 'How was your energy after lunch?';
                                          foodType = kLunch;

                                          kHow_Was_Your_Energy_After = kHow_Did_You_Feel_After_Lunch;
                                          kHow_Did_You_Feel_After = kHow_Was_Your_Energy_After_Lunch;
                                        } else if (index == 2) {
                                          howDidYoufeelAfter = 'How did you feel after dinner?';
                                          howWasYourEnergyAfter = 'How was your energy after dinner?';
                                          foodType = kDinner;

                                          kHow_Was_Your_Energy_After = kHow_Did_You_Feel_After_Dinner;
                                          kHow_Did_You_Feel_After = kHow_Was_Your_Energy_After_Dinner;
                                        } else if (index == 3) {
                                          foodType = kSnacks;
                                        }
...
//                                  FocusScope.of(context).nextFocus();
                                  if (textFoodName.text.isEmpty) {
                                    Toast.show(
                                        'Enter food name', context,
                                        backgroundColor: HexColor(redColor));
                                  }
//                                  else if (selectedTime == 'xx:xx') {
//                                    Toast.show(
//                                        'Select food time', context,
//                                        backgroundColor: HexColor(redColor));
//                                  }
                                  else if (textCalories.text.isEmpty) {
                                    Toast.show(
                                        'Enter calories', context,
                                        backgroundColor: HexColor(redColor));
                                  }
//                                  else if (selectedBreakfastFeel == 0) {
//                                    Toast.show(
//                                        howDidYoufeelAfter, context,
//                                        backgroundColor: HexColor(redColor));
//                                  } else if (selectedBreakfastEnergy == 0) {
//                                    Toast.show(
//                                        howWasYourEnergyAfter, context,
//                                        backgroundColor: HexColor(redColor));
//                                  } else if (textOtherNotes.text.isEmpty) {
//                                    Toast.show(
//                                        'Enter your other notes', context,
//                                        backgroundColor: HexColor(redColor));
//                                  }
                                  else {
                                    setFoodData();
...
//                                        howWasYourEnergyAfter, context,
//                                        backgroundColor: HexColor(redColor));
//                                  } else if (textOtherReason.text.isEmpty) {
//                                    Toast.show(
//                                        'Enter your other reason', context,
//                                        backgroundColor: HexColor(redColor));
//                                  } else if (textOtherNotes.text.isEmpty) {
//                                    Toast.show(
//                                        'Enter your other notes', context,
//                                        backgroundColor: HexColor(redColor));
//                                  } else if (textBetterOption.text.isEmpty) {
//                                    Toast.show(
//                                        'Enter your better options', context,
//                                        backgroundColor: HexColor(redColor));
//                                  }
...
//                              color: AppConstant.color_blue_dark,
//                              borderRadius: BorderRadius.circular(30)),
//                          strWeekDays: ['Mo', 'Tu', 'We', 'Th', 'Fr', 'Sa', 'Su'],
//                          defaultTextStyle: TextStyle(
//                              color: AppConstant.color_blue_dark,
//                              fontFamily: AppConstant.kPoppins,
//                              fontWeight: FontWeight.normal,
...
//                                      children: <Widget>[
//                                        Image.asset(
//                                          (selectedBreakfastFeel == 1) ? Res.selectedGoalsDetails : Res.unselectedGoalDetails,
//                                          height:24,
//                                        ),
//                                        SizedBox(width:10),
//                                        Text(
...
//                                      children: <Widget>[
//                                        Image.asset(
//                                          (selectedBreakfastFeel == 2) ? Res.selectedGoalsDetails : Res.unselectedGoalDetails,
//                                          height:24,
//                                        ),
//                                        SizedBox(width:10),
//                                        Text(
...
//                                      children: <Widget>[
//                                        Image.asset(
//                                          (selectedBreakfastFeel == 3) ? Res.selectedGoalsDetails : Res.unselectedGoalDetails,
//                                          height:24,
//                                        ),
//                                        SizedBox(width:10),
//                                        Text(
...
//                                      children: <Widget>[
//                                        Image.asset(
//                                          (selectedBreakfastFeel == 4) ? Res.selectedGoalsDetails : Res.unselectedGoalDetails,
//                                          height:24,
//                                        ),
//                                        SizedBox(width:10),
//                                        Text(
...
//                                      children: <Widget>[
//                                        Image.asset(
//                                          (selectedBreakfastEnergy == 1) ? Res.selectedGoalsDetails : Res.unselectedGoalDetails,
//                                          height:24,
//                                        ),
//                                        SizedBox(width:10),
//                                        Text(
...
//                                      children: <Widget>[
//                                        Image.asset(
//                                          (selectedBreakfastEnergy == 2) ? Res.selectedGoalsDetails : Res.unselectedGoalDetails,
//                                          height:24,
//                                        ),
//                                        SizedBox(width:10),
//                                        Text(
...
//                                      children: <Widget>[
//                                        Image.asset(
//                                          (selectedBreakfastEnergy == 3) ? Res.selectedGoalsDetails : Res.unselectedGoalDetails,
//                                          height:24,
//                                        ),
//                                        SizedBox(width:10),
//                                        Text(
...
//                                      children: <Widget>[
//                                        Image.asset(
//                                          (selectedBreakfastEnergy == 4) ? Res.selectedGoalsDetails : Res.unselectedGoalDetails,
//                                          height:24,
//                                        ),
//                                        SizedBox(width:10),
//                                        Text(
